...
- [ ] **Task: Initialize uv project and create pyproject.toml.**
    - [ ] Run `uv init --no-workspace` to create the initial `pyproject.toml`.
    - [ ] Configure the project name and version in `pyproject.toml`.
