              ...
              <div key={round} className="animate-in fade-in slide-in-from-bottom-4 duration-500">
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  {matches.filter(m => m.round_number === round).map(match => {
                    ...
                    // Can report if it's my match AND the round is active OR it's already completed but we want to allow edits
                    // The spec says: "edit capability... until the current round is officially closed"
                    // We'll allow reporting if it's NOT completed, or if it IS completed and it's my match and tournament is NOT completed.
